% Plot moving 3D gear set
% Mengtang Li
% Mar 30
clear; clf; close all;

% change the path
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\x_record1.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\x_record2.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\x_record3.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\x_record4.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\y_record1.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\y_record2.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\y_record3.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\y_record4.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\z_record1.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\z_record2.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\z_record3.mat')
load('C:\Users\lim14\Documents\MATLAB\Project_504\TAH\draw3dcircle\10\z_record4.mat')
...
% plot3(x_record2, y_record2, z_record2, 'g-.','linewidth',1);
plot3(x_record3, y_record3, z_record3, 'm-.','linewidth',1);
plot3(x_record4, y_record4, z_record4, 'r-.','linewidth',1);

clear x_record1 y_record1 z_record1;
clear x_record2 y_record2 z_record2;
clear x_record3 y_record3 z_record3;
clear x_record4 y_record4 z_record4;
...
plot3(L/2*cos(angle), L/2*sin(angle), 0*angle, 'g', 'linewidth',2)
plot3(R*cos(angle), R*sin(angle), 0*angle+R, 'g', 'linewidth',2)
pause(2);
...
for i = 1:1:n
    ...
    phi = 0:0.02:pi;
    rho2_xe = 2.5*R*cos(phi)*C(2,1)+(2.5*R*sin(phi)-h)*C(3,1);
    rho2_ye = 2.5*R*cos(phi)*C(2,2)+(2.5*R*sin(phi)-h)*C(3,2);
    rho2_ze = 2.5*R*cos(phi)*C(2,3)+(2.5*R*sin(phi)-h)*C(3,3);
    ...
    rho_x2e = 2.5*R*cos(pi/2)*C(1,1)+2.5*R*sin(pi/2)*C(2,1)-h*C(3,1);
    rho_y2e = 2.5*R*cos(pi/2)*C(1,2)+2.5*R*sin(pi/2)*C(2,2)-h*C(3,2);
    rho_z2e = 2.5*R*cos(pi/2)*C(1,3)+2.5*R*sin(pi/2)*C(2,3)-h*C(3,3);
    % extended 4nd point (270 deg) in moving frame
    rho_x4e = 2.5*R*cos(3*pi/2)*C(1,1)+2.5*R*sin(3*pi/2)*C(2,1)-h*C(3,1);
    rho_y4e = 2.5*R*cos(3*pi/2)*C(1,2)+2.5*R*sin(3*pi/2)*C(2,2)-h*C(3,2);
    rho_z4e = 2.5*R*cos(3*pi/2)*C(1,3)+2.5*R*sin(3*pi/2)*C(2,3)-h*C(3,3);
    ...
    r_z2e = R_z + rho_z2e;  z_record4(i) = r_z2e;
    % extended 4th point (270 deg) in moving frame
    r_x4e = R_x + rho_x4e;  %x_record5(i) = r_x4e;
    r_y4e = R_y + rho_y4e;  %y_record5(i) = r_y4e;
    r_z4e = R_z + rho_z4e;  %z_record5(i) = r_z4e;
    
    plotcircle1 = plot3(r_x,r_y,r_z,'b','linewidth',2);
    plotcircle2 = plot3(r2_x,r2_y,r2_z,'m','linewidth',2);
    plotcircle3 = plot3(r2_xe,r2_ye,r2_ze,'r','linewidth',2);
    plotline0 = plot3([R_x; r_xvt], [R_y; r_yvt], [R_z; r_zvt],'b','linewidth',2);
    %     plotline1 = plot3([r_x1; r_x3], [r_y1; r_y3], [r_z1; r_z3],'g','linewidth',2);
    plotline2 = plot3([r_x2; r_x4], [r_y2; r_y4], [r_z2; r_z4],'m','linewidth',2); %!!
    plotline3 = plot3([r_x2e; r_x4e], [r_y2e; r_y4e], [r_z2e; r_z4e],'r','linewidth',2);
