...
%
%     rho_x = 3*R*cos(pi+asin(0.1))*C21 + (3*R*sin(pi+asin(0.1))-(h-3*R*0.1))*C31;
%     rho_y = 3*R*cos(pi+asin(0.1))*C22 + (3*R*sin(pi+asin(0.1))-(h-3*R*0.1))*C32;
%     rho_z = 3*R*cos(pi+asin(0.1))*C23 + (3*R*sin(pi+asin(0.1))-(h-3*R*0.1))*C33;
%
