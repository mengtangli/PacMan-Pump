% Plot moving 2D gear set with 1.5R-2R gears
% Mengtang Li
% Apr 3
clear; clf; close all;
...
circle1 = viscircles([0 0], 0.5*R);
circle2 = viscircles([0 0], 1.5*R);
...
for i = 1:1:n
    ...
    A = [ cos(0.5*wt),  sin(0.5*wt);
        -sin(0.5*wt),  cos(0.5*wt);]; % bigger gear also rotates
