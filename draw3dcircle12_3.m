% Plot moving 3D gear set 3 vertex with 1.5R-2R gears, no L
% Mengtang Li
% Apr 3
clear; clf; close all;
...
for i = 1:1:n
    ...
    rho_x2 = 2*R*cos(2*pi/3)*C(1,1)+2*R*sin(2*pi/3)*C(2,1);
    rho_y2 = 2*R*cos(2*pi/3)*C(1,2)+2*R*sin(2*pi/3)*C(2,2);
    rho_z2 = 2*R*cos(2*pi/3)*C(1,3)+2*R*sin(2*pi/3)*C(2,3);
    % 3rd point (240 deg) in moving frame
    rho_x3 = 2*R*cos(4*pi/3)*C(1,1)+2*R*sin(4*pi/3)*C(2,1);
    rho_y3 = 2*R*cos(4*pi/3)*C(1,2)+2*R*sin(4*pi/3)*C(2,2);
    rho_z3 = 2*R*cos(4*pi/3)*C(1,3)+2*R*sin(4*pi/3)*C(2,3);
