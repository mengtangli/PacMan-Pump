% Plot moving 3D gear set 2 vertex (if 2, I guess it doesnt matter 
...
for i = 1:1:n
    ...
    r_x4 = R_x + rho_x4;  x_record5(i) = r_x4;
    r_y4 = R_y + rho_y4;  y_record5(i) = r_y4;
    r_z4 = R_z + rho_z4;  z_record5(i) = r_z4;
    % lower part half circle 1st point (0 deg) part
    r_p1_x = R_x + rho_p1_x;
    r_p1_y = R_y + rho_p1_y;
    r_p1_z = R_z + rho_p1_z;
